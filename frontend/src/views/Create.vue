                ...
                <div id="content" class="font15">
                  ...
                  <div style="margin: 2vw">
                    ...
                    <div style="margin: 0 auto; width: 85%">
                      ...
                      >
                        <div
                          v-if="credential.kind == 'Username_with_password'"
                        ...
                        <div
                          v-if="credential.kind == 'GitHub_App'"
                          style="font-weight:bold"
                        >
                        ...
                        <div
                          v-if="credential.kind == 'GitLap_API_token'"
                          style="font-weight:bold"
                        >
                        ...
                        <div
                          v-if="
                            credential.kind == 'SSH_Username_with_private_key'
                          "
                          style="font-weight:bold"
                        >
                    ...
                    <v-btn
                      v-if="credentialForms.length == 0"
                      @click="toggleCredentialForm"
                      >+</v-btn
                    >
                    <v-btn
                      v-if="credentialForms.length == 1"
                      @click="toggleCredentialForm"
                      >-</v-btn
                    >
                  </div>
                  ...
                  <div style="margin: 2vw">
                    ...
                    <div style="margin: 0 auto; width: 85%">
                      ...
                      >
                        <div
                          v-if="
                            server.kind == 'Spring_maven' ||
                              server.kind == 'Spring_gradle'
                          "
                          style="font-weight:bold"
                        >
...
export default {
  ...
  methods: {
    ...
    save: function() {
      axios
        .post(this.$store.state.server + "project/save", {
          project: {
            name: this.name,
            giturl: this.giturl,
